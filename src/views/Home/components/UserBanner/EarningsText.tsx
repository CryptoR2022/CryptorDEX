...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and CNR pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and CNR pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from CNR pool', data)
  }
